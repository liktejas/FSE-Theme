 ...
 * @return void
 */
function responsive_fse_remove_wc_lightbox() {
	wp_dequeue_script( 'flexslider' );
	wp_dequeue_script( 'zoom' );
	wp_dequeue_script( 'photoswipe-ui-default' );
}
add_action( 'wp_print_scripts', 'responsive_fse_remove_wc_lightbox', 100 );
 ...
 * @return void
 */
function responsive_fse_woo_setup() {
	add_theme_support(
		'woocommerce',
		array(
...
add_action( 'after_setup_theme', 'responsive_fse_woo_setup' );
