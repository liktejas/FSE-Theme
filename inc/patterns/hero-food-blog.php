...
return array(
	'title'      => __( 'Hero Food Blog', 'responsive-fse' ),
    ...
    <h2 class="has-text-align-center" style="font-size:50px">' . __( 'Bring spice to your life', 'responsive-fse' ) . '</h2>
    <!-- /wp:heading --></div>
    <!-- /wp:group -->
    ...
    <p class="has-text-align-center">' . __( 'The food reflects emotion! Here are some classic recipes from all over the world.', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-button aligncenter has-custom-font-size is-style-outline has-normal-font-size"><a class="wp-block-button__link" style="border-radius:4px">' . __( 'Read More', 'responsive-fse' ) . '</a></div>
    <!-- /wp:button --></div>
    <!-- /wp:buttons --></div>
    <!-- /wp:group --></div>
    <!-- /wp:group --></div></div>
