...
return array(
    ...
    <h2 class="has-text-align-center" style="font-size:50px">Bring spice to your life</h2>
    <!-- /wp:heading --></div>
    <!-- /wp:group -->
    ...
    <p class="has-text-align-center">The food reflects emotion! Here are some classic recipes from all over the world.</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-button aligncenter has-custom-font-size is-style-outline has-normal-font-size"><a class="wp-block-button__link" style="border-radius:4px">Read More</a></div>
    <!-- /wp:button --></div>
    <!-- /wp:buttons --></div>
    <!-- /wp:group --></div>
    <!-- /wp:group --></div></div>
