...
return array(
	'title'      => __( 'Simple Footer', 'responsive-fse' ),
    ...
    <ul class="wp-block-social-links aligncenter has-normal-icon-size has-icon-background-color is-style-default"><!-- wp:social-link {"url":"https://facebook.com","service":"facebook"} /-->
    
    <!-- wp:social-link {"url":"https://twitter.com","service":"twitter"} /-->
    
    <!-- wp:social-link {"url":"https://google.com","service":"google"} /-->
    ...
    <p class="has-text-align-center has-medium-font-size">' . __( 'LINKS', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph -->
    
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center">' . __( 'Link 1', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph -->
    
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center">' . __( 'Link 2', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph -->
    
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center">' . __( 'Link 3', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph -->
    
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center">' . __( 'Link 4', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:column -->
    <div class="wp-block-column"><!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
    <p class="has-text-align-center has-medium-font-size">LINKS' . __( 'LINKS', 'responsive-fse' ) . '</p>
    <!-- /wp:paragraph -->
