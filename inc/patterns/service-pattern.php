	...
	'content'    => '<!-- wp:cover {"overlayColor":"white","style":{"spacing":{"padding":{"top":"70px","bottom":"70px","right":"0px","left":"0px"}}}} -->
										<div class="wp-block-cover has-white-background-color has-background-dim"
											...
											<div class="wp-block-cover__inner-container">
												...
												<p class="has-text-align-center has-text-color has-normal-font-size" style="color:#f9636b;line-height:1.6">' . __( 'Our Services', 'responsive-fse' ) . '</p>
												<!-- /wp:paragraph -->
												...
												<h2 class="has-text-align-center has-dark-color has-text-color"
													style="font-size:50px;font-weight:600;line-height:1">' . __( 'What We Do', 'responsive-fse' ) . '</h2>
												<!-- /wp:heading -->

												<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.6"},"color":{"text":"#000000"}},"fontSize":"normal"} -->
												<p class="has-text-align-center has-text-color has-normal-font-size" style="color:#000000;line-height:1.6">' . __( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'responsive-fse' ) . '</p>
												<!-- /wp:paragraph -->
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																...
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'Brand Strategy', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->

																<!-- wp:paragraph {"style":{"typography":{"lineHeight":1.6}},"textColor":"dark","fontSize":"normal"} -->
																<p class="has-dark-color has-text-color has-normal-font-size" style="line-height:1.6">' . __( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum.', 'responsive-fse' ) . '</p>
																<!-- /wp:paragraph -->
															</div>
														</div>
														<!-- /wp:media-text -->
													...
													<div class="wp-block-column has-white-background-color has-background"
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																<!-- wp:heading {"style":{"typography":{"lineHeight":"1","fontWeight":"700"}},"textColor":"dark","fontSize":"medium"} -->
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'Modern Design', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->
													...
													<div class="wp-block-column has-white-background-color has-background"
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																<!-- wp:heading {"style":{"typography":{"lineHeight":"1","fontWeight":"700"}},"textColor":"dark","fontSize":"medium"} -->
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'Security Data', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->
													...
													<div class="wp-block-column has-white-background-color has-background"
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																<!-- wp:heading {"style":{"typography":{"lineHeight":"1","fontWeight":"700"}},"textColor":"dark","fontSize":"medium"} -->
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'Data Analysis', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->
													...
													<div class="wp-block-column has-white-background-color has-background"
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																<!-- wp:heading {"style":{"typography":{"lineHeight":"1","fontWeight":"700"}},"textColor":"dark","fontSize":"medium"} -->
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'SEO Optimization', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->
													...
													<div class="wp-block-column has-white-background-color has-background"
														...
														<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center"
															...
															<div class="wp-block-media-text__content">
																<!-- wp:heading {"style":{"typography":{"lineHeight":"1","fontWeight":"700"}},"textColor":"dark","fontSize":"medium"} -->
																<h2 class="has-dark-color has-text-color has-medium-font-size"
																	style="font-weight:700;line-height:1">' . __( 'Best Marketing', 'responsive-fse' ) . '</h2>
																<!-- /wp:heading -->
