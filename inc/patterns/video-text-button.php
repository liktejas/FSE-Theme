        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-columns are-vertically-aligned-top">
                ...
                <div class="wp-block-column is-vertically-aligned-top">
                    ...
                    <h2 class="has-text-color" style="color:#111111;font-size:32px;font-weight:700;line-height:1">Meet Our Experts</h2>
                    <!-- /wp:heading -->
                    ...
                    <div class="wp-block-buttons">
                        ...
                        <div class="wp-block-button has-custom-font-size" style="font-size:18px"><a
                                ...
                                style="border-radius:5px;background-color:#3c63ae;padding-top:15px;padding-right:30px;padding-bottom:15px;padding-left:30px">Learn More</a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
