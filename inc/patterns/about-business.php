...
return array(
    ...
    <h2 class="alignwide has-text-color has-large-font-size" id="we-re-a-studio-in-berlin-with-an-international-practice-in-architecture-urban-planning-and-interior-design-we-believe-in-sharing-knowledge-and-promoting-dialogue-to-increase-the-creative-potential-of-collaboration" style="color:#166dd5;line-height:1.1">' . __( 'About Us', 'tailwindfse' ) . '</h2>
    <!-- /wp:heading -->
    
    <!-- wp:heading {"style":{"color":{"text":"#071e57"}}} -->
    <h2 class="has-text-color" style="color:#071e57">' . __( 'Entrepreneur solutions', 'tailwindfse' ) . '</h2>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"style":{"color":{"text":"#748494"},"typography":{"lineHeight":"1.8"}}} -->
    <p class="has-text-color" style="color:#748494;line-height:1.8">' . __( 'We are a boutique consulting firm owned and operated by MBA candidates at CU Boulder. Whether your business is a growing startup or an established firm, our customized solutions and contemporary skills deliver results.', 'tailwindfse' ) . '</p>
